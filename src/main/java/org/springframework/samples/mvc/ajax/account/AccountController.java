...
public class AccountController {
	...
	public String getCreateForm(Model model) {
		System.out.println("chiamata get..");
	...
	public Account create(@RequestBody Account account, HttpServletResponse response) {
		System.out.println("POST CALLED: account.left = " + account.getLeft());
		
		accounts.put(account.assignId(), account);

		System.out.println("after assign id: account.left = " + account.getLeft());
	...
	public Account get(@PathVariable Long id) {
		System.out.println("getLongId account");
		Account account = accounts.get(id);
		System.out.println(account.getLeft());
		if (account == null) {
